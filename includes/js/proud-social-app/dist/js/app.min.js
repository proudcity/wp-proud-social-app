...
$scope.switchService=function(event,service,limit,callback){callback=callback||function(){},event&&event.preventDefault();var isActive=$scope.isServiceActive(service),runQuery=!1,callback=callback||function(){},limit=limit||20;
// switch active
