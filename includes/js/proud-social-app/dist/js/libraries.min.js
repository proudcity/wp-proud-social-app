...
elements=$document[0].querySelectorAll(".dynamic-layout-item-parent:not(.ng-leave)"),items=[];for(var i=0;i<elements.length;++i){
...
function getColumns(){return columns}/*
     ...
     */
function initColumns(nb){columns=[];var i;for(i=0;i<nb;++i)columns.push([]);return columns}/*
